          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 text-center lg:text-left z-10">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold text-gray-800">
                ...
                <span className="block" style={{ color: "#a89f94" }}>
                  de nuestro bebé
                </span>
              ...
              <p className="text-lg text-gray-600 max-w-xl">
                Únete a nosotros para celebrar este momento tan especial. Un día
                lleno de amor, alegría y dulces sorpresas para dar la bienvenida
                a nuestro pequeño príncipe.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <Button
                  variant="outline"
                  className="px-8 py-6 text-lg rounded-full border-2 cursor-pointer transition duration-300"
                  style={{ borderColor: "#a89f94", color: "#8b7355" }}
                  onClick={() => {
            ...
            <div className="relative z-10">
              ...
              <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-3xl shadow-2xl">
                ...
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-white px-6 py-2 rounded-full shadow-lg">
                  ...
                  >
                    {" "}
                    <Heart className="w-4 h-4 fill-current" /> Ecografía
                  </span>
                </div>
              </div>
